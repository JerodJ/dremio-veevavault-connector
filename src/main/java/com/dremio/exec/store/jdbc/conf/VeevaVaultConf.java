...
@SourceType(value = "VeevaVaultARP", label = "VeevaVault",uiConfig = "veevavault-layout.json")
public class VeevaVaultConf extends AbstractArpConf<VeevaVaultConf> {
  private static final String ARP_FILENAME = "arp/implementation/veevavault-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.veevavault.VeevaVaultDriver";
